    ...
    render() {
        return (
            <div className="container detailContainer">
             <div id="hero-img"><img class="card-img-top" src="https://source.unsplash.com/1600x900/?nature,flowers" alt="" style={{zIndex:"1"}}/>
      </div>
      <div class="container detailContainer">
        <div class="text-center">
          <img class="img-avatar rounded-circle" src="https://api.adorable.io/avatars/285" style={{zIndex:"100"}}/>
